...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'Do you offer financing?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We work with multiple financing partners, with payments as low as $74 per month. Approval takes about 60 seconds with no impact to your credit score to check your options.' } },
...
const costFaqs = [
  { q: 'How much does crawl space encapsulation cost in Kansas City?', a: "Every crawl space is different, so the price depends on your specific situation — your home's size, the current condition, and which system fits. That's why we give you a firm written quote after a free inspection instead of a phone guess. Financing is available with payments as low as $74 per month." },
  ...
  { q: 'Do you offer financing?', a: 'Yes. We work with multiple financing partners, with payments as low as $74 per month. Approval takes about 60 seconds with no impact to your credit score to check your options. Your exact payment depends on your home and scope of work.' },
